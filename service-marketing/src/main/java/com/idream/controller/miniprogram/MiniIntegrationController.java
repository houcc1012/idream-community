 ...
 */
@RestController
@RequestMapping(value = "/miniProgram/integration")
@Api(tags = "抽奖相关接口（小程序）", description = "miniIntegrationController")
public class MiniIntegrationController {
    ...
    @ApiOperation("轮播中奖记录")
    public JSONPublicDto<List<MarketingRecordDto>> getRecord() {
        List<MarketingRecordDto> list = integrationService.listLastRecord();
